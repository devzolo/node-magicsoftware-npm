import { func as EdgeFunc } from 'edge-js';
import path from 'path';

const MgRequesterDll = path.resolve(__dirname, '..', '..', 'bin', process.platform, process.arch, 'MgRequester.dll');

export const MgRequester = EdgeFunc<null, void>(`
    //#r "System.Core.dll"
    //#r "System.Data.dll"
